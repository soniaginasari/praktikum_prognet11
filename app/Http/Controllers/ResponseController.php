...
class ResponseController extends Controller
{
    ...
    {
        $response = Review::select('product_reviews.id','product_id','user_id','rate','content','status','product_name')->join('products','product_reviews.product_id','=','products.id')->orderBy('product_reviews.created_at','desc')
            ->get();
